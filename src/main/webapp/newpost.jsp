        ...
        <main id="main-section">
            ...
            <article>
                <div id="post-author">
                    <a href="#">
                        <div>
                            <img src="img/DP.jpeg" alt="" />
                            <div>
                                <div>
                                    <strong id="post-author-name" name="email"><%=fname%></strong
                                    >
...
<form method="post" action="uploadImageServlet" enctype="multipart/form-data">
                ...
                ></textarea>
                    ...
                    <button id="btn-picture">
                        <span class="fas fa-camera"><input class="input100 txtb" type="file" name="myimg" accept="image/*"></span>
                    </button><a href="home-copy.jsp">.</a>
                    <input id="new-post" type="submit" name="submit" class="submit action-button" value="Post" />
